...
$sele="SELECT * FROM users_items WHERE users_id= $userid and status='confirmed' ";
...
?></td>
      <td  width="10%"><?php echo $row['delivery']?></td>
      <?php if($row['delivery']=="notdelivered"){?>
     <td  width="20%"> <a href="cancel.php?ide=<?php echo $row['product_id']; ?>" name="add" value="add" class="btn  btn-danger">cancel order</a> </td> 
<?php } } }?>
    </tr>
    ...
    <footer style="background-color: white;">
        <div >
                <center>
                    <p>Copyright © dukhan.in. All Rights Reserved | Contact Us: 9642914399,9626222139</p>	
                </center>
            </div>
        </footer>
</html>
